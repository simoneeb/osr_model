from BA1_Model import BA1_Model
...
#name the simulation
folder_name = 'params_manual_N_fixed_OFF_biphasic_ON_wB_7_wA1_12_diffsf'
...
#weights
wB_init = 7.0             # [1/s]
wA1_init = -12# -11.0 #-90.0    #20.8   # [1/s]
...
params_model['SFA2'] = params_model['SFA2'] *2 # (80/50)
...
filepath = "/user/sebert/home/Documents/Repositories/osr_model/outputs/"
...
Model = BA1_Model(linear_filter = linear_filter,      
